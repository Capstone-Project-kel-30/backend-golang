...
func (_m *UserRepository) FindByUserID(userID string) (*entity.User, error) {
...
func (_m *UserRepository) UpdateUserExpiry(userID string, expiry string, memberType string) error {
