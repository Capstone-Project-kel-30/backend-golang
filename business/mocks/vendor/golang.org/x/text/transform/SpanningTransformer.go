...
type mockConstructorTestingTNewSpanningTransformer interface {
	mock.TestingT
	Cleanup(func())
}

// NewSpanningTransformer creates a new instance of SpanningTransformer. It also registers a testing interface on the mock and a cleanup function to assert the mocks expectations.
func NewSpanningTransformer(t mockConstructorTestingTNewSpanningTransformer) *SpanningTransformer {
	mock := &SpanningTransformer{}
	mock.Mock.Test(t)
