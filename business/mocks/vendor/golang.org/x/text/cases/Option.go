...
func (_m *Option) Execute(o cases.options) cases.options {
	ret := _m.Called(o)

	var r0 cases.options
	if rf, ok := ret.Get(0).(func(cases.options) cases.options); ok {
		r0 = rf(o)
	} else {
		r0 = ret.Get(0).(cases.options)
	}
