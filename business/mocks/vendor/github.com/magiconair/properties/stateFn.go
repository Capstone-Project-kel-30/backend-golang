...
func (_m *stateFn) Execute(_a0 *properties.lexer) properties.stateFn {
	ret := _m.Called(_a0)

	var r0 properties.stateFn
	if rf, ok := ret.Get(0).(func(*properties.lexer) properties.stateFn); ok {
		r0 = rf(_a0)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(properties.stateFn)
		}
	}
