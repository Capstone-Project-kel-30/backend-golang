...
// Add provides a mock function with given fields: key, text, override
func (_m *Translator) Add(key interface{}, text string, override bool) error {
	ret := _m.Called(key, text, override)

	var r0 error
	if rf, ok := ret.Get(0).(func(interface{}, string, bool) error); ok {
		r0 = rf(key, text, override)
	} else {
		r0 = ret.Error(0)
	}
...
// AddCardinal provides a mock function with given fields: key, text, rule, override
func (_m *Translator) AddCardinal(key interface{}, text string, rule locales.PluralRule, override bool) error {
	ret := _m.Called(key, text, rule, override)

	var r0 error
	if rf, ok := ret.Get(0).(func(interface{}, string, locales.PluralRule, bool) error); ok {
		r0 = rf(key, text, rule, override)
	} else {
		r0 = ret.Error(0)
	}
...
// AddOrdinal provides a mock function with given fields: key, text, rule, override
func (_m *Translator) AddOrdinal(key interface{}, text string, rule locales.PluralRule, override bool) error {
	ret := _m.Called(key, text, rule, override)
...
// AddRange provides a mock function with given fields: key, text, rule, override
func (_m *Translator) AddRange(key interface{}, text string, rule locales.PluralRule, override bool) error {
	ret := _m.Called(key, text, rule, override)
...
// C provides a mock function with given fields: key, num, digits, param
func (_m *Translator) C(key interface{}, num float64, digits uint64, param string) (string, error) {
	ret := _m.Called(key, num, digits, param)

	var r0 string
	if rf, ok := ret.Get(0).(func(interface{}, float64, uint64, string) string); ok {
		r0 = rf(key, num, digits, param)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(interface{}, float64, uint64, string) error); ok {
		r1 = rf(key, num, digits, param)
	} else {
		r1 = ret.Error(1)
	}
...
// O provides a mock function with given fields: key, num, digits, param
func (_m *Translator) O(key interface{}, num float64, digits uint64, param string) (string, error) {
	ret := _m.Called(key, num, digits, param)
...
// R provides a mock function with given fields: key, num1, digits1, num2, digits2, param1, param2
func (_m *Translator) R(key interface{}, num1 float64, digits1 uint64, num2 float64, digits2 uint64, param1 string, param2 string) (string, error) {
	ret := _m.Called(key, num1, digits1, num2, digits2, param1, param2)

	var r0 string
	if rf, ok := ret.Get(0).(func(interface{}, float64, uint64, float64, uint64, string, string) string); ok {
		r0 = rf(key, num1, digits1, num2, digits2, param1, param2)
	} else {
		r0 = ret.Get(0).(string)
	}

	var r1 error
	if rf, ok := ret.Get(1).(func(interface{}, float64, uint64, float64, uint64, string, string) error); ok {
		r1 = rf(key, num1, digits1, num2, digits2, param1, param2)
	} else {
		r1 = ret.Error(1)
	}
...
// T provides a mock function with given fields: key, params
func (_m *Translator) T(key interface{}, params ...string) (string, error) {
...
// VerifyTranslations provides a mock function with given fields:
func (_m *Translator) VerifyTranslations() error {
	ret := _m.Called()
